 ...
 *
 */
public class MessengerMdsalUtils {

    private static final Logger LOG = LoggerFactory.getLogger(MessengerMdsalUtils.class);

    public static InstanceIdentifier<Messenger> getMessengerIid() {
